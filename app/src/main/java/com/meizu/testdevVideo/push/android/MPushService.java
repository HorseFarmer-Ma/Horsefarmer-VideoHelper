...
//        MPushReceiver.startAlarm(this, heartbeat - 1000);
        // 自定义20秒后检查心跳
        AlarmSetting.getInstance().canalAlarm(this, MPushReceiver.ACTION_HEALTH_CHECK);
        AlarmSetting.getInstance().setOnceAlarm(this, MPushReceiver.ACTION_HEALTH_CHECK, System.currentTimeMillis() + 5000);
