...
public class CommonVariable {
    ...
    public static String about_phone_browser_version = "";  // 浏览器版本号
    public static String about_phone_theme_version = "";    // 主题版本号
    ...
    public static String strU2ApkId = null ;
    public static String strU2AndroidTestApkId = null ;
    public static String strUpdateApkId = null ;
